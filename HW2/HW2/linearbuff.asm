...
; section 3: Convolution block start from here ....
	...
	MAC *AR5+,*AR4+, AC0			    ; AC1= (value at Address(AR5) x value at Address(AR4)) 
                    					; Also, address at AR5 and AR4 increments by one (points to the next memory location of size word, i.e, 16 bits)					; Accumulate the product in accumulator AC0
